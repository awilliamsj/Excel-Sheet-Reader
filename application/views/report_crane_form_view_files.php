...
$directory2 = 'crane_uploads_csv/crane_uploads/';
...
array_walk($inputFileNames2, 'test_alter2', 'crane_uploads_csv/crane_uploads/');
...
$xlsWriter2->setPreCalculateFormulas(false);
$xlsWriter2->setUseBOM(true);
//you could write a loop to create directories first too
$xlsWriter2->save("././filecounter2/$folderNum/$numDataCells");
