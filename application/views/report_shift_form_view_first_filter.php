...
array_walk($inputFileNames3, 'test_alter3', 'shift_uploads/');
...
$objReader3->setLoadSheetsOnly(array(0));
...
*/
$numDataCells2 = (1000 - $rowCounter3);
...
$xlsWriter3->save("././shift_uploads_csv/$inputFileName3.csv");
