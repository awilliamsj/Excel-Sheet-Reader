...
class Report_Shift_Form_Controller extends CI_Controller {
 ...
 // $this->load->view('templates/header', $data);
    ...
    //delete the files first before generating a new series to append
		  ...
		  delete_files('././filecounter/0/');
		  delete_files('././filecounter/1/');
		  delete_files('././filecounter/2/');
		  delete_files('././filecounter/3/');
		  delete_files('././filecounter/4/');
		  delete_files('././filecounter/5/');
		  delete_files('././filecounter/6/');
		  delete_files('././filecounter/7/');
		  delete_files('././filecounter/8/');
		  delete_files('././filecounter/9/');
		  delete_files('././filecounter/10/');
		  
		  delete_files('././shift_uploads_csv/shift_uploads/');
		  
		  
		  $this->load->view('report_shift_form_view_first_filter');
